  ...
  return (
    <div className='text-center mt-4'>
      <div className='flex flex-col gap-5'>
        <span className=' text-primary bg-gray-100 rounded-xl px-4 py-2 mx-auto'>Best job hunt website </span>
        ...
        <div className="flex items-center mx-auto w-full max-w-2xl rounded-full border border-input bg-background shadow-sm transition-colors focus-within:ring-2 focus-within:ring-ring/30">
          <input
            type="text"
