  ...
  return (
    <div className="mt-30 md:mt-5 flex items-center justify-center px-4">
      <div className="relative w-full max-w-md overflow-hidden rounded-2xl p-0.5">
        <div className="absolute inset-[-150%] animate-[spin_4s_linear_infinite] bg-[conic-gradient(from_0deg,transparent_0deg,#07AAA5_45deg,transparent_90deg)]"
        />
        <form
          onSubmit={submitHandler}
          className="relative w-full rounded-2xl border border-gray-200 dark:border-gray-800 bg-background p-6 sm:p-8 shadow-xl"
        >
